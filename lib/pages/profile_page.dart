...
class ProfilePage extends ConsumerStatefulWidget {
  ...
  ProfilePage({Key? key, required this.openDrawer});
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            SizedBox(width: 20,),
                            Icon(Icons.payment, size: 30), // Adjust the size as needed
                            SizedBox(width: 15), // Add some spacing between the icon and the text
                            Text(
                              'Payment Option',
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            SizedBox(width: 20,),
                            Icon(Icons.favorite_border, size: 30), // Adjust the size as needed
                            SizedBox(width: 15), // Add some spacing between the icon and the text
                            Text(
                              'Wish List',
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            SizedBox(width: 20,),
                            Icon(Icons.gif_box_outlined, size: 30), // Adjust the size as needed
                            SizedBox(width: 15), // Add some spacing between the icon and the text
                            Text(
                              'My Order',
                              style: TextStyle(
